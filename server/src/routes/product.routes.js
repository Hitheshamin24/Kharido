...
import { addProductsController } from "../controller/product.controller.js";
...
router.post("/",authenticate,authenticateSeller,uploadImage.array("images"),parseSize,productValidator,addProductsController)
